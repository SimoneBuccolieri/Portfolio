    ...
    <div class="max-w-5xl mx-auto px-4 sm:px-6 md:px-12" data-aos="fade-up">
      ...
      <div class="bg-white rounded-2xl p-6 sm:p-8 md:p-12 shadow-sm border border-gray-100 relative overflow-hidden" data-aos="fade-up" data-aos-delay="100">
        ...
        <div class="space-y-6 text-lg text-gray-700 leading-relaxed md:text-xl md:leading-10 relative z-10">
          <p>
            Il mio percorso accademico si sta svolgendo presso l'<span class="font-bold text-gray-900">Università degli Studi di Padova</span>, dove frequento il corso di Laurea in <span class="font-bold text-blue-600">Informatica</span>.
          </p>
          <p>
            Questo ambiente mi ha permesso di esplorare a fondo le fondamenta della Computer Science degli algoritmi, lo sviluppo software, ponendo basi solide con una mentalità logica ed orientata al problem-solving. L'esperienza universitaria mi permette non solo di approcciare nuove tecnologie, ma di padroneggiarne i principi teorici sottostanti.
          </p>
        </div>
      </div>
    </div>
